...
Relational Databases is the system that stores data in a tabular form. SQL is the standard language used to manage data within databases.

- [x] Why do tables need a `primary key`?
Primary keys are important in order grab data by unique identifable key. Without these requirements, they are rejected from the database.
